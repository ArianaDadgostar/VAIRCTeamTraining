...
class Program
{
    ...
    // Color
    class ConvertColor     : IComputerVision { public string from       { get; set; } public string to         { get; set; } }
    class Grayscale        : IComputerVision { }
    class Threshold        : IComputerVision { public double thresh     { get; set; } public double maxval     { get; set; } public string type { get; set; } }
    class AdaptiveThresh   : IComputerVision { public double maxval     { get; set; } public string method     { get; set; } public string type { get; set; } public int blockSize { get; set; } public double C { get; set; } }
    class InRange          : IComputerVision { public int    lh         { get; set; } public int    ls         { get; set; } public int    lv  { get; set; } public int uh { get; set; } public int us { get; set; } public int uv { get; set; } }
    class EqualizeHist     : IComputerVision { }

    // Blur
    class GaussianBlur     : IComputerVision { public int    ksize      { get; set; } public double sigmaX    { get; set; } }
    class MedianBlur       : IComputerVision { public int    ksize      { get; set; } }
    class BilateralFilter  : IComputerVision { public int    d          { get; set; } public double sigmaColor { get; set; } public double sigmaSpace { get; set; } }
    class Blur             : IComputerVision { public int    ksize      { get; set; } }

    // Morphology
    class Erode            : IComputerVision { public int    ksize      { get; set; } public int    iterations { get; set; } }
    class Dilate           : IComputerVision { public int    ksize      { get; set; } public int    iterations { get; set; } }
    class MorphOpen        : IComputerVision { public int    ksize      { get; set; } }
    class MorphClose       : IComputerVision { public int    ksize      { get; set; } }
    class MorphGradient    : IComputerVision { public int    ksize      { get; set; } }

    // Edge
    class Canny            : IComputerVision { public double thresh1    { get; set; } public double thresh2    { get; set; } }
    class Sobel            : IComputerVision { public int    dx         { get; set; } public int    dy         { get; set; } public int ksize { get; set; } }
    class Laplacian        : IComputerVision { public int    ksize      { get; set; } }

    // Geometry
    class Resize           : IComputerVision { public int    width      { get; set; } public int    height     { get; set; } }
    class Rotate           : IComputerVision { public double angle      { get; set; } }
    class Flip             : IComputerVision { public int    flipCode   { get; set; } }
    class Crop             : IComputerVision { public int    x          { get; set; } public int    y          { get; set; } public int width { get; set; } public int height { get; set; } }
    class Warp             : IComputerVision { public double m00        { get; set; } public double m01        { get; set; } public double m02 { get; set; } public double m10 { get; set; } public double m11 { get; set; } public double m12 { get; set; } }

    // Drawing
    class DrawCircle       : IComputerVision { public int    cx         { get; set; } public int    cy         { get; set; } public int radius { get; set; } public int r { get; set; } public int g { get; set; } public int b { get; set; } public int thickness { get; set; } }
    class DrawRectangle    : IComputerVision { public int    x          { get; set; } public int    y          { get; set; } public int width  { get; set; } public int height { get; set; } public int r { get; set; } public int g { get; set; } public int bl { get; set; } public int thickness { get; set; } }
    class PutText          : IComputerVision { public string text       { get; set; } public int    x          { get; set; } public int y { get; set; } public double scale { get; set; } public int r { get; set; } public int g { get; set; } public int b { get; set; } }

    // Detection
    class HoughLines       : IComputerVision { public double rho        { get; set; } public double theta      { get; set; } public int thresh { get; set; } }
    class HoughCircles     : IComputerVision { public double dp         { get; set; } public double minDist    { get; set; } public double param1 { get; set; } public double param2 { get; set; } public int minRadius { get; set; } public int maxRadius { get; set; } }
    class FindContours     : IComputerVision { public string mode       { get; set; } public string method     { get; set; } }

    // Arithmetic
    class AddWeighted      : IComputerVision { public double alpha      { get; set; } public double beta       { get; set; } public double gamma { get; set; } }
    class Normalize        : IComputerVision { public double alpha      { get; set; } public double beta       { get; set; } }
    class BitwiseNot       : IComputerVision { }

    // I/O
    class SaveFrame        : IComputerVision { public string path       { get; set; } }
    class ShowWindow       : IComputerVision { public string title      { get; set; } }
    ...
    public static void MacCameraFeed(List<IComputerVision> pipeline)
    {
                ...
                using (var frame = new Mat()){
                    while (true){
                        ...
                        foreach(IComputerVision feature in pipeline){
                            ...
                            RunPipeline(feature, capture, frame);
                        }
